...
class BaiduSpeechRecognition {
  ...
  Future<String> init() =>
      _channel.invokeMethod('speechInit').then((result) => result);

  /// start normal speech recognition
  Future<String> start() =>
      _channel.invokeMethod('speechStart').then((result) => result);

  /// start long speech recognition
  Future<String> startLongSpeech() =>
      _channel.invokeMethod('speechStartLong').then((result) => result);

  /// stop speech recognition
  Future<String> stop() =>
      _channel.invokeMethod('speechStop').then((result) => result);

  /// cancel speech recognition
  Future<String> cancel() =>
      _channel.invokeMethod('speechCancel').then((result) => result);
  ...
  Stream<String>? get speechRecognitionEvents {
    if (_onVoiceRecognitionCallback == null) {
      _onVoiceRecognitionCallback =
          _callback.receiveBroadcastStream().map((dynamic event) => event);
    }
